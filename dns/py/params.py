...
class DeploymentContainerSpecParam(Param):
  ...
  def is_relevant(self, attributes):
    return 'cluster-dns' not in attributes and 'nodelocaldns' not in attributes
...
# specifies that the test is run with nodelocaldns
ATTRIBUTE_NODELOCAL_DNS = 'nodelocaldns'
